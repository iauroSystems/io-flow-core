...
@Module({
  ...
  providers: [TasksService, UserTasksRepositoryImpl, ProcessInstanceRepositoryImpl, ProcessDefinitionRepositoryImpl, HttpConnector, Compiler, Executor, GrpcConnector,OpenAIConnector],
})
