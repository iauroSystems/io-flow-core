...
import { GrpcConnector, KafkaConnector, OpenAIConnector } from "src/shared/connectors";
...
@Module({
  ...
  providers: [ProcessDefinitionService, ProcessDefinitionRepositoryImpl, GrpcConnector,KafkaConnector,OpenAIConnector, Compiler],
})
